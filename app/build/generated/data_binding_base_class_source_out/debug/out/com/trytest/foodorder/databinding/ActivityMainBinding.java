...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView recyclerViewRestaurant) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.recyclerViewRestaurant;
      RecyclerView recyclerViewRestaurant = ViewBindings.findChildViewById(rootView, id);
      if (recyclerViewRestaurant == null) {
        break missingId;
      }

      return new ActivityMainBinding((ConstraintLayout) rootView, recyclerViewRestaurant);
    }
